...
| 2 | [Pallas RMSNorm + matmul-prologue fusion](hypotheses/llama3-jax-rmsnorm-matmul-prologue-fusion.md) | llama3-8b-jax | +3-6 % step time | medium | L |
| 3 | [Pallas SwiGLU + down_proj fusion](hypotheses/llama3-jax-pallas-swiglu-downproj-fusion.md) | llama3-8b-jax | +2-4 % step time | medium-low *(pallas-forge TPU SwiGLU loses to XLA on v5e — validate via HLO before kernel write)* | L |

All three filed 2026-04-27 from the [exp 28b post-frontier ablation series](experiments/llama3_8B_autoresearch_optimization/jax/experiments/2026-04-26-jax-exp27-28-sparsecore-rs-ag-offload-frontier.md#wave-45-ablation-summary-exp-3960). The bf16-MXU optimization regime is saturated by knob-tuning; remaining wins require either custom Pallas kernels (#2, #3) or int8 quantization (#1).
